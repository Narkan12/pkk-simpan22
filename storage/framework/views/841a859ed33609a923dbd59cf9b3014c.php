        ...
        <div class="navbar-inner">
            ...
            <div class="navbar-center">
                <div class="nav-logo-img">
                    <img src="<?php echo e(asset('images/logo.png')); ?>" class="object-cover" style="width:100%;height:100%;">
                </div>
            ...
            <div class="navbar-right">
                ...
                <a class="btn-masuk" href="<?php echo e(route('login')); ?>">MASUK</a>
            </div>
        </div>
    </nav>
            ...
            <div class="d-flex align-center" style="min-height:600px;">
                <div class="landing-hero-img" style="flex:none;width:35%;display:flex;align-items:flex-end;"
                    ...
                    <div style="margin-top:6rem;width:400px;height:500px;overflow:hidden;">
                        <img src="<?php echo e(asset('images/woman-welcome.png')); ?>" alt=""
    ...
    <section style="padding:4rem 0 5rem;background:#fff;margin-top:6rem;" id="search" data-aos="fade-up"
        ...
        <div class="container-search">
            ...
            <div
                ...
                <form method="POST" action="<?php echo e(route('search')); ?>#search">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-input-wrapper">
                                ...
                                <input type="text" id="nip" name="nip" placeholder="Masukkan NIP"
                                    class="form-input" value="<?php echo e(request('nip')); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="form-input-wrapper">
                                ...
                                <input type="text" id="nama" name="nama" placeholder="Masukkan Nama"
                                    class="form-input" value="<?php echo e(request('nama')); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <select id="departemen" name="departemen" class="form-select">
                                ...
                                <?php $__currentLoopData = $departemen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($dept->id); ?>"
                                        <?php echo e(request('departemen') == $dept->id ? 'selected' : ''); ?>>
                            ...
                            <select id="jabatan" name="jabatan" class="form-select">
                                ...
                                <?php $__currentLoopData = $jabatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($jab->id); ?>"
                                        <?php echo e(request('jabatan') == $jab->id ? 'selected' : ''); ?>>
                    ...
                    <div class="d-flex" style="gap:0.875rem;align-items:center;">
                        ...
                        <a href="<?php echo e(route('landing')); ?>#search" class="btn-reset"
            ...
            <?php if(isset($hasil) && count($hasil) > 0): ?>
                <div style="margin-top:3rem;">
                    <h3 style="font-size:1.5rem;font-weight:700;color:#1e5b2e;margin-bottom:1.5rem;">Hasil Pencarian
                        (<?php echo e(count($hasil)); ?> ditemukan)</h3>
                    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:1.5rem;">
                        <?php $__currentLoopData = $hasil; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pegawai): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div
                                ...
                                <div class="d-flex align-center" style="gap:1rem;margin-bottom:1rem;">
                                    ...
                                    <div>
                                        <h4 style="font-size:1.125rem;font-weight:700;color:#1f2937;">
                                            <?php echo e($pegawai->nama_lengkap); ?></h4>
                                        <p style="font-size:0.875rem;color:#6b7280;">NIP: <?php echo e($pegawai->NIP); ?></p>
                                    </div>
                                </div>
                                <div style="display:flex;flex-direction:column;gap:0.5rem;font-size:0.875rem;">
                                    <div style="display:flex;justify-content:space-between;">
                                        ...
                                        <span
                                            style="font-weight:600;color:#1f2937;"><?php echo e($pegawai->departemen->nama_departemen ?? '-'); ?></span>
                                    </div>
                                    <div style="display:flex;justify-content:space-between;">
                                        <span style="color:#4b5563;">Jabatan:</span>
                                        <span
                                            style="font-weight:600;color:#1f2937;"><?php echo e($pegawai->jabatan->nama_jabatan ?? '-'); ?></span>
                                    </div>
                                    <div style="display:flex;justify-content:space-between;">
                                        <span style="color:#4b5563;">No. Telp:</span>
                                        <span
                                            style="font-weight:600;color:#1f2937;"><?php echo e($pegawai->no_telp ?? '-'); ?></span>
                                    </div>
                                    <div style="display:flex;justify-content:space-between;">
                                        <span style="color:#4b5563;">Alamat:</span>
                                        <span
                                            style="font-weight:600;color:#1f2937;text-align:right;"><?php echo e(Str::limit($pegawai->alamat, 30) ?? '-'); ?></span>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php elseif(isset($hasil) && count($hasil) == 0): ?>
...
<?php /**PATH C:\laragon\www\PKK-Simpan22\resources\views\landing.blade.php ENDPATH**/ ?>