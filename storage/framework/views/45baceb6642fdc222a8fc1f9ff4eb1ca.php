...
<?php $__env->startSection('title', 'Laporan Data Pegawai'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;margin-top:1rem;margin-bottom:1rem;">
        ...
        <a href="<?php echo e(route('laporan.exportPegawai')); ?>"
    ...
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:1rem;margin-bottom:1rem;">
        ...
        <div class="custom-card" style="border-radius:0.75rem;padding:1.25rem;">
            ...
            <h3 style="color:#22c55e;font-size:1.5rem;font-weight:700;margin:0.5rem 0 0;"><?php echo e($aktif); ?></h3>
        </div>
        <div class="custom-card" style="border-radius:0.75rem;padding:1.25rem;">
            <p class="custom-paragraph" style="font-size:0.875rem;margin:0;">Non-Aktif / Lainnya</p>
            <h3 style="color:#f87171;font-size:1.5rem;font-weight:700;margin:0.5rem 0 0;"><?php echo e($nonAktif); ?></h3>
        </div>
        <div class="custom-card" style="border-radius:0.75rem;padding:1.25rem;">
            <p class="custom-paragraph" style="font-size:0.875rem;margin:0;">Total Departemen</p>
            <h3 style="color:#fff;font-size:1.5rem;font-weight:700;margin:0.5rem 0 0;"><?php echo e($totalDept); ?></h3>
        </div>
    </div>
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <tr>
                        ...
                        <td style="font-weight:600;color:#fff;"><?php echo e($p->nama_lengkap); ?></td>
                        <td><?php echo e(optional($p->jabatan)->nama_jabatan ?? '-'); ?></td>
                        <td><span class="status-departemen"><?php echo e(optional($p->departemen)->nama_departemen ?? '-'); ?></span></td>
                        <td><?php echo e($p->tanggal_masuk ? \Carbon\Carbon::parse($p->tanggal_masuk)->format('d M Y') : '-'); ?></td>
                        <td><span class="<?php echo e($badge); ?>"><?php echo e($statusName); ?></span></td>
                    </tr>
...
<?php echo $__env->make('layouts.layout-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PKK-Simpan22\resources\views\laporan\laporan-pegawai.blade.php ENDPATH**/ ?>