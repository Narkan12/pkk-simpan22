    ...
    <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:1.5rem;">
        ...
        <div class="card-activity"
            ...
            <div style="max-height: 400px; overflow-y: auto; padding-right: 0.5rem;" class="custom-scrollbar">
                <?php $__empty_1 = true; $__currentLoopData = $aktivitasTerbaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    text-transform: uppercase;">
                            <?php echo e(substr($log->nama_lengkap, 0, 1)); ?>
                        ...
                        <div style="flex: 1; border-bottom: 1px solid #f8fafc; padding-bottom: 0.75rem;">
                            <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                                <span class="activity-name"
                                    style="font-weight: 600; color: #334155; font-size: 0.9375rem;"><?php echo e($log->nama_lengkap); ?></span>
                                <span class="activity-time"
                                    style="font-size: 0.75rem; color: #94a3b8; white-space: nowrap;">
                                    <i class="bi bi-clock"
                                        style="margin-right: 3px;"></i><?php echo e($log->created_at->diffForHumans()); ?>
    ...
    <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:1.5rem;margin-top:1.5rem;">
        ...
        <div class="card-statistic" style="padding:1.25rem;">
            ...
            <div class="stat-item">
                ...
                <span class="stat-value"><?php echo e($totalDepartemen); ?></span>
            </div>
            <div class="stat-item">
                <span class="stat-label">Total Status Pegawai</span>
                <span class="stat-value"><?php echo e($totalStatus); ?></span>
            </div>
            <div class="stat-item">
                <span class="stat-label">Total Golongan Pegawai</span>
                <span class="stat-value"><?php echo e($totalGolongan); ?></span>
            </div>
            <div class="stat-item">
                <span class="stat-label">Total Jabatan Pegawai</span>
                <span class="stat-value"><?php echo e($totalJabatan); ?></span>
            </div>
        </div>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                const labels = <?php echo json_encode($departemenStats->pluck('nama_departemen') ?? []); ?>;
                const dataCounts = <?php echo json_encode($departemenStats->pluck('employees_count') ?? []); ?>;
...
<?php echo $__env->make('layouts.layout-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PKK-Simpan22\resources\views\dashboard.blade.php ENDPATH**/ ?>