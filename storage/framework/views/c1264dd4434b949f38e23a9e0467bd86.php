...
<?php $__env->startSection('title', 'Manajemen Gaji'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="cards-grid-3" style="display:grid;grid-template-columns:repeat(3,1fr);gap:1rem;margin-bottom:1rem;">
        ...
        <div style="background:#eff6ff; border:1px solid #bfdbfe; border-radius:0.75rem; padding:1.25rem;">
            ...
            <p style="color:#1e40af; font-size:1.75rem; font-weight:700; margin:0.25rem 0 0;"><?php echo e($totalPegawai); ?></p>
        </div>
        ...
        <div style="background:#f0fdf4; border:1px solid #bbf7d0; border-radius:0.75rem; padding:1.25rem;">
            ...
            <p style="color:#15803d; font-size:1.75rem; font-weight:700; margin:0.25rem 0 0;"><?php echo e($sudahDibayar); ?></p>
        </div>
        ...
        <div style="background:#fef2f2; border:1px solid #fecaca; border-radius:0.75rem; padding:1.25rem;">
            ...
            <p style="color:#b91c1c; font-size:1.75rem; font-weight:700; margin:0.25rem 0 0;"><?php echo e($belumDibayar); ?></p>
        </div>
    </div>
            ...
            <div style="flex:1;min-width:150px;">
                ...
                <select id="filterTahun" class="modal-input" onchange="filterGaji()">
                    <?php $__currentLoopData = $tahunList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($t); ?>" <?php if($t == $tahun): ?> selected <?php endif; ?>>
                            <?php echo e($t); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
        ...
        <table class="w-full">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $gaji; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td>
                            <div style="font-weight:600;color:#fff;"><?php echo e($g->pegawai->nama_lengkap); ?></div>
                            <div style="color:#8b949e;font-size:0.75rem;margin-top:2px;"><?php echo e($g->pegawai->NIP ?? '-'); ?>

                            </div>
                        </td>
                        <td><?php echo e($g->pegawai->jabatan->nama_jabatan ?? '-'); ?></td>
                        <td>Rp <?php echo e(number_format($g->pegawai->jabatan->gaji_pokok ?? 0, 0, ',', '.')); ?></td>
                        <td>Rp <?php echo e(number_format($g->pegawai->jabatan->tunjangan ?? 0, 0, ',', '.')); ?></td>
                        <td>Rp <?php echo e(number_format($g->potongan, 0, ',', '.')); ?></td>
                        <td style="color:#fff;font-weight:600;">Rp <?php echo e(number_format($g->total_gaji, 0, ',', '.')); ?></td>
                        <td>
                        ...
                        <td>
                            <?php if($g->status_bayar === 'Belum Dibayar'): ?>
                                <form action="<?php echo e(route('gaji.update', $g->id)); ?>" method="POST" style="display:inline;">
                                    <?php echo csrf_field(); ?>
                            ...
                            <?php endif; ?>
                            <form action="<?php echo e(route('gaji.destroy', $g->id)); ?>" method="POST" style="display:inline;"
    ...
    <form id="generateForm" action="<?php echo e(route('gaji.store')); ?>" method="POST" style="display:none;">
        <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        function filterGaji() {
            const bulan = document.getElementById('filterBulan').value;
            const tahun = document.getElementById('filterTahun').value;
            window.location.href = '<?php echo e(route('manajemen-gaji')); ?>?bulan=' + bulan + '&tahun=' + tahun;
        }
    </script>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.layout-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PKK-Simpan22\resources\views\manajemen\manajemen-gaji.blade.php ENDPATH**/ ?>