...
<div id="<?php echo e($id); ?>" class="hidden"
    ...
    <div class="custom-card" style="border-radius:0.75rem;width:100%;margin:0 1rem;max-width:460px;">
        ...
        <div
            style="display:flex;align-items:center;justify-content:space-between;padding:1rem 1.25rem;border-bottom:1px solid #1f1f1f;">
        ...
        <div
            style="display:flex;justify-content:flex-end;gap:0.5rem;padding:1rem 1.25rem;border-top:1px solid #1f1f1f;">
            <button onclick="closeModal('<?php echo e($id); ?>')" class="modal-btn-cancel"
                style="flex:none;">Batal</button>
            <button type="button" onclick="document.getElementById('<?php echo e($formTarget); ?>').submit()"
                style="display:flex;align-items:center;gap:0.5rem;padding:0.5rem 1rem;border-radius:0.5rem;font-size:0.875rem;font-weight:600;color:#fff;cursor:pointer;border:none;background:#1a6fdf;">
...
<?php /**PATH C:\laragon\www\PKK-Simpan22\resources\views\components\modal\add.blade.php ENDPATH**/ ?>