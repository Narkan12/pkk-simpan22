...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/manajemen-cuti/{id}/cetak',       [ManajemenController::class, 'cetakSuratCuti'])->name('manajemen-cuti.cetak');
    ...
    // Manajemen HRD (admin: CRUD, owner: view only)
    Route::get('/manajemen-hrd',              [HrdController::class, 'index'])->name('manajemen-hrd');
    Route::post('/manajemen-hrd',             [HrdController::class, 'store'])->name('hrd.store');
    Route::put('/manajemen-hrd/{user}',       [HrdController::class, 'update'])->name('hrd.update');
    Route::delete('/manajemen-hrd/{user}',    [HrdController::class, 'destroy'])->name('hrd.destroy');
