...
class DataMasterController extends Controller
{
    ...
    /** Kembalikan redirect back dengan flash pesan sukses */
    private function respondSuccess(string $pesan)
    {
        return back()->with('success', $pesan);
    }

    /** Catat aktivitas ke tabel log_activities */
    ...
    /** Tampilkan halaman dashboard admin dengan statistik kepegawaian */
    public function dashboard()
    {
        ...
        $aktivitasTerbaru = LogActivities::latest()->take(5)->get();
        ...
        return view('dashboard', compact(
            'totalPegawai', 'pegawaiAktif', 'pegawaiNonAktif', 'statusLainnya',
            'totalJabatan', 'totalDepartemen', 'totalStatus', 'totalGolongan',
            'departemenStats', 'aktivitasTerbaru'
        ));
    }
    ...
    /** Tampilkan daftar seluruh pegawai beserta statistik ringkas */
    public function indexPegawai()
    {
        ...
        // $data dipertahankan agar view tidak perlu diubah
        $data = $daftarPegawai;

        return view('data-pegawai', compact(
            'data', 'totalPegawai', 'pegawaiAktif', 'pegawaiNonAktif', 'pegawaiLainnya',
            'jabatanList', 'departemenList', 'statusList', 'golonganList', 'pendidikanList'
        ));
    }

    /** Simpan pegawai baru beserta akun login-nya */
    public function storePegawai(Request $request)
    {
        // Validasi data pegawai + data akun login
        $request->validate([
        ...
        // Buat akun login: username = nama_lengkap, email & password dari form
        ...
        // Siapkan data pegawai dari form
        $dataPegawai = $request->only([
            'NIK', 'NIP', 'nama_lengkap', 'jenis_kelamin', 'tanggal_lahir',
            'tempat_lahir', 'agama', 'alamat', 'no_telp', 'status_pernikahan',
            'jenis_pegawai', 'id_jabatan', 'id_departemen', 'id_golongan',
            'id_status', 'id_pendidikan', 'tanggal_masuk',
        ]);
        ...
        return $this->respondSuccess("Pegawai {$pegawaiBaru->nama_lengkap} berhasil ditambahkan. Username login: {$request->nama_lengkap}");
    }
    ...
    public function updatePegawai(Request $request, Employees $pegawai)
    {
        ...
        // Kumpulkan kolom yang berubah untuk log aktivitas
        $kolomDipantau = [
            'nama_lengkap' => 'Nama', 'NIK' => 'NIK', 'NIP' => 'NIP',
            'agama' => 'Agama', 'alamat' => 'Alamat', 'id_jabatan' => 'Jabatan',
            'id_departemen' => 'Departemen', 'id_status' => 'Status Pegawai', 'foto' => 'Foto',
        ];
    ...
    /** Hapus pegawai beserta akun login-nya */
    ...
    public function updateJabatan(Request $request, Jabatan $jabatan)
    {
        ...
        $kolomDipantau = [
            'kode_jabatan' => 'Kode Jabatan', 'nama_jabatan' => 'Nama Jabatan',
            'level' => 'Level', 'gaji_pokok' => 'Gaji Pokok', 'tunjangan' => 'Tunjangan',
        ];
        $kolomBerubah = array_values(array_filter(
    ...
    public function updateDepartemen(Request $request, Departemen $departemen)
    {
        ...
        $kolomDipantau = [
            'kode_departemen' => 'Kode', 'nama_departemen' => 'Nama',
            'kepala_departemen' => 'Kepala', 'lokasi' => 'Lokasi',
        ];
        $kolomBerubah = array_values(array_filter(
    ...
    /** Tampilkan daftar status pegawai */
    ...
    public function updateGolongan(Request $request, Golongan $golongan)
    {
        ...
        $kolomDipantau = [
            'kode_golongan' => 'Kode', 'nama_golongan' => 'Nama',
            'pangkat' => 'Pangkat', 'ruang' => 'Ruang', 'eselon' => 'Eselon',
        ];
        $kolomBerubah = array_values(array_filter(
    ...
    /** Perbarui data jenjang pendidikan */
    public function updatePendidikan(Request $request, Pendidikan $pendidikan)
    {
        ...
        $kolomDipantau = [
            'kode_pendidikan' => 'Kode', 'jenjang' => 'Jenjang',
            'lama_studi' => 'Lama Studi', 'deskripsi' => 'Deskripsi',
        ];
        $kolomBerubah = array_values(array_filter(
    ...
    /** Tampilkan daftar komponen gaji */
    ...
    public function updateKomponenGaji(Request $request, KomponenGaji $komponenGaji)
    {
        ...
        $kolomDipantau = [
            'kode_komponen' => 'Kode', 'nama_komponen' => 'Nama',
            'jenis' => 'Jenis', 'tipe_nominal' => 'Tipe Nominal', 'nominal' => 'Nominal',
        ];
        $kolomBerubah = array_values(array_filter(
