...
@section('content')
    ...
    <form method="GET" action="{{ route('absensi') }}" class="custom-card rounded-xl p-4" style="margin-bottom:1rem;">
        ...
        <button type="submit" style="margin-top:0.75rem;padding:0.5rem 1rem;border-radius:0.5rem;color:#fff;font-size:0.875rem;font-weight:600;border:none;cursor:pointer;background:#1a5c2e;">
