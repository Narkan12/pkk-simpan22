...
@section('content')
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;margin-top:1rem;margin-bottom:1rem;">
        ...
        <a href="{{ route('laporan.exportPegawai') }}"
           style="display:inline-flex;align-items:center;gap:0.5rem;padding:0.5rem 1rem;border-radius:0.5rem;color:#fff;font-size:0.875rem;font-weight:600;background:#1a5c2e;text-decoration:none;">
