...
{{-- Modal Tambah Cuti --}}
<x-modal.add id="modalTambahCuti" title="Tambah Pengajuan Cuti">
...
{{-- Modal Hapus Cuti --}}
<x-modal.delete id="modalHapusCuti" title="Hapus Pengajuan Cuti" nama="Budi Santoso" kode="Cuti Tahunan" />
